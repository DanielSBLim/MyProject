									...
									<tr>
										...
										<td class =text-right>
											<c:if test="${sessionScope.id == rvo.id}">
												<a href="#" class ="btn btn-sm btn-success del_update" value="${rvo.no }">수정</a>
												<a href="reply_delect.jsp?no=${rvo.no }&bno=${vo.no}&page=${curpage}" class ="btn btn-sm btn-danger">삭제</a>
											</c:if>
										</td>
									</tr>
									<tr>
										<td colspan="2" valign="top" align="left">
											<pre style="background-color: rgb(92, 70, 45);
											 opacity: 0.5; color: #FFF;" >${rvo.msg }</pre>
										</td>
									</tr>
